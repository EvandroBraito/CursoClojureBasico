...
;  deve chamar a funcao new-card, e assim gerar uma nova carta
;  atualiza o vetor cards dentro do player
;  calcular os pontos com o novo vetor de cartas
;  retornar novo jogador
...
; se passaram de 21 -> ambos perderam
; pontos iguais -> empatou
; passou de 21 -> dealer ganhou
